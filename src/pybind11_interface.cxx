...
void init_COSMO(py::module &m) {
    ...
    py::class_<COSMO1, AbstractCOSMOModel>(m, "COSMO1")
        ...
        .def("get_lngamma_resid", (EigenArray1 (COSMO1::*)(double, const EigenArray1&) const) &COSMO1::get_lngamma_resid)
        .def("get_lngamma_resid", (double (COSMO1::*)(std::size_t, double, const EigenArray1&) const) &COSMO1::get_lngamma_resid)
    ...
    py::class_<COSMO3, AbstractCOSMOModel>(m, "COSMO3")
        ...
        .def("get_lngamma_resid", (EigenArray (COSMO3::*)(double, const EigenArray&) const) &COSMO3::get_lngamma_resid)
        .def("get_lngamma_resid", (double (COSMO3::*)(std::size_t, double, const EigenArray&) const) &COSMO3::get_lngamma_resid)
